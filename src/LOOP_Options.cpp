...
void LOOP_Options()
{
  ...
  while(!QuitProgram && !QuitToMenu)
  {
    ...
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 4) {Audio::setMusicVolume(VolumePercentage_Music += 10, true); Audio::playSound(Audio::AudioTypeEnum::AUDIO_CLICK);}
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 5) {Audio::setMusicVolume(VolumePercentage_Music -= 10, true); Audio::playSound(Audio::AudioTypeEnum::AUDIO_CLICK);}
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 6) {Audio::setSoundEffectsVolume(VolumePercentage_Sound += 10, true); Audio::playSound(Audio::AudioTypeEnum::AUDIO_CLICK);}
    if(!Key_LALT &&(Key_ENTER_pressed || Joy_OK_pressed) && Menu.ActiveOptions == 7) {Audio::setSoundEffectsVolume(VolumePercentage_Sound -= 10, true); Audio::playSound(Audio::AudioTypeEnum::AUDIO_CLICK);}
